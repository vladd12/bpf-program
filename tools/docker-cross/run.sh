...
#docker cp <ID>:/usr/lib/arm-linux-gnueabihf/libbpf.so libbpf.so
#docker cp <ID>:/usr/lib/arm-linux-gnueabihf/libbpf.so.1 libbpf.so.1
docker cp <ID>:/usr/lib/arm-linux-gnueabihf/libbpf.so.1.1.0 libbpf.so.1.1.0
ln -s ./libbpf.so.1.1.0 ./libbpf.so.1
ln -s ./libbpf.so.1.1.0 ./libbpf.so

docker cp <ID>:/usr/lib/libbcc-loader-static.a libbcc-loader-static.a
docker cp <ID>:/usr/lib/libbcc.a libbcc.a
#docker cp <ID>:/usr/lib/libbcc.so libbcc.so
#docker cp <ID>:/usr/lib/libbcc.so.0 libbcc.so.0
...
#docker cp <ID>:/usr/lib/libbcc_bpf.so libbcc_bpf.so
#docker cp <ID>:/usr/lib/libbcc_bpf.so.0 libbcc_bpf.so.0
docker cp <ID>:/usr/lib/libbcc_bpf.so.0.25.0 libbcc_bpf.so.0.25.0
ln -s ./libbcc_bpf.so.0.25.0 ./libbcc_bpf.so.0
ln -s ./libbcc_bpf.so.0.25.0 ./libbcc_bpf.so
